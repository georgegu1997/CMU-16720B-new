...
axes[1, 0].set_title('warped check')

# For the warped image I implement
warped_im_self = warpA.warp(im_gray, A, output_shape)

axes[1, 1].imshow(warped_im_self, cmap=plt.get_cmap('gray'))
